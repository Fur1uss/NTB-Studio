...
import { FormSubmissionEmailEssential } from '../../../emails/FormSubmissionEmailEssential';
...
export async function POST(request) {
  try {
    ...
    const emailHtml = await render(
      React.createElement(FormSubmissionEmailEssential, {
        formData: formData,
      })
    );
    ...
    const { data, error } = await resend.emails.send({
      ...
      subject: `Nueva Solicitud - Plan Essential - ${formData.nombre}`,
      html: emailHtml,
